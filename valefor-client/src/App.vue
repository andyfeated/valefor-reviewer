    ...
    <div class="w-full max-w-md relative">
      ...
      >
        ...
        <motion.button
          :while-hover="{ scale: 1.03 }"
          :while-press="{ scale: 0.95 }"
          class="relative w-full cursor-pointer flex items-center gap-3 px-4 py-4 bg-[#141414] border border-[#2a2a2a] hover:border-blue-500/50 rounded-xl text-[#e8e8e8] font-medium overflow-hidden"
        >
          <motion.div
            :animate="{ x: ['-100%', '100%'] }"
      ...
      >
        <p>Secure OAuth • Read-only access • Clean and minimal</p>
      </motion.div>
    </div>
  </div>
</template>
